...
const Waitlist = () => {
  ...
  /**
   * Submits the waitlist form to Django backend API
   * The backend saves data to database and can send confirmation email
   */
    ...
    try {
      ...
      const response = await fetch(API_ENDPOINTS.WAITLIST_SUBMIT, {
        ...
        body: JSON.stringify({
          ...
          // Note: userId is now generated by the backend
        }),
      });
